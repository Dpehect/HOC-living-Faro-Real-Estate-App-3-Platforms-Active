...
struct HomeView: View {
    ...
    var body: some View {
        NavigationStack {
            ScrollView {
                VStack(spacing: 0) {
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        Text("Homes across Portugal & Spain, starting in Faro")
                            .font(.title2.bold())
                            .foregroundStyle(AppTheme.textPrimary)

                        Text("Search live listings — from Algarve apartments to homes in Lisbon, Porto and beyond.")
                            .font(.body)
                    ...
                    VStack(alignment: .leading, spacing: 16) {
                        Text("Why HOC Living Faro?")
                            .font(.title3.bold())

                        FeatureRow(icon: "building.2", title: "Local expertise", subtitle: "Deep knowledge of Faro and Algarve market.")
            ...
            .navigationTitle("HOC Living Faro")
            .navigationBarTitleDisplayMode(.inline)
            .toolbar {
                ToolbarItem(placement: .principal) {
                    Text("HOC Living Faro")
                        .font(.headline.bold())
                        .foregroundStyle(AppTheme.primary)
                }
            }
