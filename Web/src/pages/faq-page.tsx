...
const faqs = [
	{ q: 'Which areas do you cover?', a: 'We list properties across Portugal and Spain, with a strong focus on the Algarve, Lisbon, Porto and major Spanish cities such as Madrid, Barcelona, Seville and Málaga.' },
	...
	{ q: 'Can foreign buyers purchase property?', a: 'Yes. Non-residents can buy in Portugal and Spain. We coordinate with trusted legal partners for due diligence and contracts.' },
...
export default function FaqPage() {
	return (
		<PageShell title="FAQs" subtitle="Answers to common questions about buying, renting and listing with HOC Living Faro.">
