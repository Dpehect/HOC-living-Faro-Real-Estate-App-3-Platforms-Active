...
const faqs = [
	{ q: 'Which areas do you cover?', a: 'We list properties across München and Bayern, with a strong focus on the Bayern, Lisbon, Porto and major Spanish cities such as Madrid, Barcelona, Seville and Málaga.' },
	...
	{ q: 'Can foreign buyers purchase property?', a: 'Yes. Non-residents can buy in München and Bayern. We coordinate with trusted legal partners for due diligence and contracts.' },
